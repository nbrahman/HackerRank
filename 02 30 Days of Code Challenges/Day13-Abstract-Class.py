...
Note: Because these classes are being written in the same file, you must not use an access modifier (e.g.: pubic) when declaring MyBook or your code will not execute.
