...
Complete the Difference class by writing the following:
    ...
    A class constructor that takes an array of integers as a parameter and saves it to the elemets instance variable.
...
You are not responsible for printing any output; the Solution class will print the value of the instance maximumDifference variable.
    ...
    def computeDifference(self):
        for i in range(len(self.elements)):
            for j in range(i+1,len(self.elements)):
                if abs(self.elements[i]-self.elements[j]) > self.maximumDifference:
