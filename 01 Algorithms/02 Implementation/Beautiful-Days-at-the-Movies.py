'''
Lily likes to play games with integers and their reversals. For some integer x, we define reversed(x) to be the reversal of all digits in . For example, reversed(123)=321, reversed(21)=12, and reversed(120)=21.
