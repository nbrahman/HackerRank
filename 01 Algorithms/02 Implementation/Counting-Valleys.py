...
The second line contains a single string of n characters. Each character is U or D (where U indicates a step up and D indicates a step down), and the ith character in the string describes Gary's ith step during the hike.
